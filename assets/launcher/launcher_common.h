...
int player2_profile_enabled;
    ...
    int player3_profile_enabled;
    char player3_profile[MAX_PATH_LEN];
    char player3_profile_options[MAX_CMD_LEN];
    char player3_profile_arguments[MAX_CMD_LEN];
    int player4_profile_enabled;
    char player4_profile[MAX_PATH_LEN];
    char player4_profile_options[MAX_CMD_LEN];
    char player4_profile_arguments[MAX_CMD_LEN];

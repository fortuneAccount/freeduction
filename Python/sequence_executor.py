...
class SequenceExecutor:
    ...
    This version uses the plugin system for tool execution, with generic
    app execution for pre/post launch scripts.
    """
    ...
    def __init__(self, launcher):
        ...
        # Generic app actions for pre/post launch scripts
    ...
    def _execute_action(self, action_name: str, is_exit: bool):
        """Execute a single action via the plugin system or generic app execution."""
        ...
        if action_name in self.plugin_actions:
            ...
            if self._execute_plugin_action(plugin_name, is_exit):
                return
            # If plugin execution failed, fall through to generic app execution
    ...
    def run_generic_app(self, app_attr, wait_attr, options_attr=None, args_attr=None):
        """Run a generic application for pre/post launch scripts."""

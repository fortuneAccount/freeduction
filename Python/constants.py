...
NORMALIZED_STEAM_INDEX_CACHE = "normalized_steam_games.cache"

# GOG database and cache
GOG_JSON_FILE = os.path.join(APP_ROOT_DIR, "gogdb.json")
NORMALIZED_GOG_INDEX_CACHE = "normalized_gog_games.cache"

# Combined index (Steam + GOG merged)

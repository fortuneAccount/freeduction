...
CONFIG_SCHEMA = {
    ...
    'Paths': {
        ...
        'multimonitortool': 'file',
        'multimonitoroptions': 'text',
        'multimonitorarguments': 'text',
        'player1profile': 'file',
        'player2profile': 'file',
        'mediacenterprofile': 'file',
        'multimonitorgamingconfig': 'file',
        'multimonitordesktopconfig': 'file',
        'cloudapp': 'file',
...
KEY_ABBREVIATIONS = {
    ...
    'multimonitortool': 'MultiMon',
    'multimonitoroptions': 'MM Opts',
    'multimonitorarguments': 'MM Args',
    'multimonitorgamingconfig': 'MM Game Cfg',
    'multimonitordesktopconfig': 'MM Desktop Cfg',
    'player1profile': 'P1 Profile',
    'player2profile': 'P2 Profile',
    'mediacenterprofile': 'MC Profile',
    'cloudapp': 'Cloud App',
